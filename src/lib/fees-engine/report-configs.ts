...
export const REPORT_CONFIGS: ReportConfig[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { key: 'billedToDatePaise', header: 'Paid vs Due Demands', align: 'right', format: 'currency' },
      { key: 'advancePaise', header: 'Advance (future demands)', align: 'right', format: 'currency' },
      { key: 'status', header: 'Status', align: 'center', format: 'chip' },
    ],
  },
  ...
  },
  {
    ...
    columns: [
      ...
      { key: 'otherDiscountsPaise', header: 'Manual Concessions', align: 'right', format: 'currency' },
  ...
  },
  {
    ...
    columns: [
      ...
      { key: 'admissionNo', header: 'Adm No', align: 'left' },
      { key: 'classSection', header: 'Class-Sec', align: 'center' },
      { key: 'concessionType', header: 'Fee Head', align: 'left', format: 'chip' },
